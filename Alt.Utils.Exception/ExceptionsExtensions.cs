...
namespace Alt.Utils.Exceptions
{
    public static class ExceptionsExtensions
    {
        public static string ExtrairMensagem(this Exception exception) 
            => exception.InnerException != null ?
                exception.InnerException.ExtrairMensagem() :
                exception.Message;
        ...
        /// <returns></returns>
        public static string ToLogString(this Exception ex, string additionalMessage = null)
        {
